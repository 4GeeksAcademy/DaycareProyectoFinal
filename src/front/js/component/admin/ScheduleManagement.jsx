...
const Sidebar = () => (
  <div className="tw-w-64 tw-bg-gray-100 tw-p-4">
    <h2 className="tw-text-xl tw-font-bold tw-mb-4">Dashboard</h2>
    <ul>
      <li className="tw-mb-2">
        <a href="#" className="tw-text-blue-600 hover:tw-text-blue-800">
          Horarios
        </a>
      </li>
    </ul>
...
const SchedulesTable = ({ filteredSchedules, handleDeleteSchedule, handleEditSchedule }) => (
